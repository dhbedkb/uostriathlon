...
append_once("assets/css/main.css", "/* FINAL PACKAGE: committee crop cards */", """
/* FINAL PACKAGE: committee crop cards */
...
# ---------------------------------------------------------------------
# 7. Image optimisation workflow and script
# ---------------------------------------------------------------------
...
print("Installed committee CMS preview, crop framing, and image optimisation package.")
